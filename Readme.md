...
Prensez aussi à choisir un mot de passe dans le Dockerfile présent dans le dossier Nominatim_Docker ainsi que dans le dossier Docker  ENV POSTGRESQL_PASSWORD MOTDEPASSE
