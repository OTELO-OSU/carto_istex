...
class ParallelCurl {
    ...
    public function startRequest($url, $callback, $user_data = array(), $post_fields=null,$id) {
	...
	while ($active && $mrc == CURLM_OK) {
        ...
        while ($info = curl_multi_info_read($this->multi_handle)) {
            ...
            $id = $request['id'];
            $country= new \istex\backend\controller\CountryController;

           $country->on_request_done($content, $url, $ch, $user_data,$id);
